...
//     <div>
//       {/* Landing Section */}
//       <div className="relative bg-blue-900  min-h-screen flex flex-col justify-center items-center text-gray-200 text-center overflow-hidden">
...
//         />
//         <motion.div
//           className="absolute h-auto max-w-full inset-0 bg-cover bg-right opacity-1"
//           style={{
//             y: y2,
//             scale: scale2,
